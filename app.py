...
@app.route('/table')
def table():
    #https://icps-9cc0a.firebaseio.com/
    firebase1 = firebase.FirebaseApplication('https://project-grs-default-rtdb.firebaseio.com/', None)
...
def loginto():
    ...
    usern = features[0]
    passw =features[1]
    if usern == "7901690198" and passw== "farmer123":
